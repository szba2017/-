...
<div class="menu_bg">
    <div class="menu">
        ...
        <ul class="menu_r">
            ...
            <c:forEach items="${productCategoryVoList}" var="temp">
            <!-- level=1& -->
                <li><a href="${ctx}/queryProductList?category=${temp.productCategory.id}">${temp.productCategory.name}</a></li>
            </c:forEach>
        </ul>
                ...
                <ul>
                    <c:forEach items="${temp.productList}" var="productVo">
                        <li>
                            ...
                            <div class="img">
                                <a href="${ctx}/product?id=${productVo.id}">
                                    <img src="${ctx}/${productVo.fileName}" width="185"  height="155"/>
                                </a>
                            </div>
                        </li>
                    </c:forEach>
